            ...
            if(isNaN(cedula)==false){
              console.log("PI-3.2: Validando cédula");
                ...
                if(usuarioTemp==cedula){
                  ...
                  crearMecanico(tipouser, cedula, nombre,apellido, email, direccion, telefono, nombreMecanica, password, sucursal);
...
function crearMecanico(tipouser, cedula, nombre,apellido, email, direccion, telefono, nombreMecanica, password, sucursal){
